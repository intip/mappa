...
/*
     FILE ARCHIVED ON 11:05:47 Dec 24, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:41:19 Sep 23, 2015.
...
$(function () {
    ...
    var URL_ULTIMOS = HOST + '/modulos/' + APP_ID + '/listarConteudoSitex'
    var p = Pagination({
        ...
        list_container_add: function (item, index) {
          $('<div class="lista-dicas"><div><h2>'+item.campo_1_1+'</h2><span>'+item.campo_1_2+'</span></div></div>').appendTo(this.list_container);
        },
